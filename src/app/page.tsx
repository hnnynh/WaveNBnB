  ...
  return (
    <div className="flex flex-col items-center justify-center text-center text-black m-1">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <div className="flex flex-col gap-2 m-3 mt-0 mb-2">
          <p className="m-2 mt-0 mb-0">친절 예약</p>
        ...
        <div className="flex flex-col gap-2 m-3 mt-0 mb-2">
          <p className="m-2 mt-0 mb-0">바로가기</p>
        ...
        <div className="grid grid-row-4 sm:grid-cols-2 gap-2 p-3 sm:pt-0 pt-3 items-center justify-center">
          <a
